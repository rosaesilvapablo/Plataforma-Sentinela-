    ...
    defaultValues: existing
      ? {
          ...
          dataEncerramento: existing.dataEncerramento
            ? toDateString(existing.dataEncerramento)
            : "",
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
        ...
        <Alert tone="warning" className="text-xs">
          <strong>Lei 9.807/99.</strong> NÃO armazene aqui dados pessoais reais da testemunha
          (nome, endereço, contato). Use código identificador interno. Dados sensíveis ficam em
          sistemas com sigilo apropriado.
        </Alert>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Field
            label="Caso / Operação / Processo"
            htmlFor="caso"
            required
            error={errors.caso?.message}
          >
            <Input id="caso" invalid={!!errors.caso} {...register("caso")} />
          </Field>
          ...
          <Field
            ...
            hint="Apenas se status=encerrado."
          >
